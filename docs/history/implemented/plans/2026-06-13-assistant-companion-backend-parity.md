...
**Prerequisite:** Base app implemented per `docs/history/implemented/plans/2026-06-12-assistant-companion-plan.md` (auth, list, chat, location, basic SSE `token`/`done`).

**Backend specs:**
- `docs/history/implemented/specs/2026-06-13-conversation-title-generation-design.md`
- `docs/history/implemented/specs/2026-06-13-message-edit-design.md`
- `docs/history/implemented/specs/2026-06-13-assistant-process-stream-design.md`
...
Add section to `docs/history/implemented/specs/2026-06-12-hermes-assistant-companion-design.md` referencing v1.4 SSE contract and process UI — or keep plan as source of truth.
