...
# Companion Apple MCP: inject the active conversation user on each HTTP request
# to the configured ``apple`` MCP server (see api_server patch and messaging-api
# X-Companion-User-Id header).
